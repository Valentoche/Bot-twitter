...
DEVELOPER_KEY = "YOUR DEVELOPER_KEY"   #variable pour la connexion à youtube
YOUTUBE_API_SERVICE_NAME = "youtube"
YOUTUBE_API_VERSION = "v3"

youtube = build(YOUTUBE_API_SERVICE_NAME, YOUTUBE_API_VERSION, developerKey=DEVELOPER_KEY)

search_response = youtube.search().list(q='beat saber',part='snippet',maxResults=5).execute()    # recherche sur youtube sur 1 thèmes
